...
const DetailScreen = () => {
	...
	const navigateToDetailAgain = () => navigation.push(nav.detail);
	// const goBack = () => navigation.goBack();
	const navigateToHome = () => navigation.navigate(nav.home)
	const navigateToBlank = () => navigation.navigate(nav.blank);
